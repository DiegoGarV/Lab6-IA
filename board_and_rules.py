...
def minimax(board, depth, alpha, beta, maximizing_player, player, use_alpha_beta=True):
    ...
    is_terminal = board.check_winner(1) or board.check_winner(2) or len(valid_columns) == 0
    ...
    if maximizing_player:
        ...
        for column in valid_columns:
            ...
            eval = minimax(board_copy, depth-1, alpha, beta, False, player, use_alpha_beta)[1]
            if eval > max_eval:
                max_eval = eval
                best_column = column
            if use_alpha_beta:
        ...
        for column in valid_columns:
            ...
            eval = minimax(board_copy, depth-1, alpha, beta, True, player, use_alpha_beta)[1]
            if eval < min_eval:
                min_eval = eval
                best_column = column
            if use_alpha_beta:
